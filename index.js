...
module.exports = {
	...
	amazon: function(keyword, cb) {
		...
		async.each(extensions, function requestSuggests(extension, cb){
			...
			var url = 'http://completion.amazon.co.uk/search/complete?method=completion&q='.concat(combination, '&search-alias=aps&client=amazon-search-ui&mkt=4&fb=1&xcat=0&x=updateISSCompletion&sc=1');
